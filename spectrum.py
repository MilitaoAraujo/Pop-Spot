...
class AudioSpectrum:
    def __init__(self):
        ...
        self._proc    = None
        self._running = False
        # Garante que start() não seja chamado duas vezes antes do _loop setar _running
    ...
    def _loop(self):
        ...
        try:
            self._proc = subprocess.Popen(
                [
                    ...
                    "--format=s16le",
                    "--latency-msec=80",
                    "-d", "@DEFAULT_MONITOR@",  # monitora saída de áudio sem interferir
                ],
        ...
        # Encerramento limpo: terminar o filho e aguardar para evitar zumbi
        try:
